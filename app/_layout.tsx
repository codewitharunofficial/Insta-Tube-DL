  ...
  return (
    <ThemeProvider value={colorScheme === "dark" ? DarkTheme : DefaultTheme}>
      <Stack>
        ...
        <Stack.Screen
          name="instagram"
          options={{ title: "Instagram Downloader", headerShown: true, headerBackButtonDisplayMode: "minimal" }}
        />
        <Stack.Screen
          name="youtube"
          options={{ title: "YouTube Downloader", headerShown: true, headerBackButtonDisplayMode: "minimal" }}
        />
        <Stack.Screen
          name="ytToMp3"
          options={{ title: "YouTube to MP3", headerShown: true, headerBackButtonDisplayMode: "minimal" }}
        />
      </Stack>
    </ThemeProvider>
  );
